...
ls_data <- get_ls_data(clean_fat_data)
...
__season 1__ is defined as follows: lean (season): 7-10 (july-october), productive (season): 1-6 & 11,12 , or
...
### __IV Fat rate evolution with bone 'freshness'__

<br> 

Here I plotted both replicates fat rates (boxplots) and sample mean fat rates (scatterplot), against bone freshness, with   

+ J_base: sample originally included andanalysed within 6 days 
+ J8: sample analyses 8 days after collection (?)
+ J9 : sample analysed 9 days after collection
+ J12: sample analyses 12 days after collection
...
fat_rate_evol_data <- get_fat_rate_evol_data(tab = fat_data_raw_2,
                       save = F)
...
#### A) Replicate fat rate as a function of bone 'freshness'
...
#### B) Sample mean fat rate as a function of bone 'freshness'
